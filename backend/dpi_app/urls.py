...
urlpatterns = [
    ...
    path('medicine/delete/<int:pk>', DeleteUpdateMedicineAPIView.as_view(), name='delete-medicine'),
    path('consultation/create', CreateConsultationAPIView.as_view(), name='create-consultation'),
    path('consultation/update/<int:pk>', UpdateConsultationAPIView.as_view(), name='update-consultation'),
